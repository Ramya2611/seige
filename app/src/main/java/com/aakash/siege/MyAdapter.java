...
public class MyAdapter extends RecyclerView.Adapter<MyAdapter.ViewHolder> {
    ...
    public MyAdapter(List<String> myDataset,List<String> myAddress,List<String> myLandmark,List<String> myCapacity,List<String> myContact) {
        mDataset = myDataset;
        maddress = myAddress;
